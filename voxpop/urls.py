...
urlpatterns = [
    ...
    path(
        "voxpops/<uuid:voxpop_id>/questions/new",
        views.new_question,
        name="new_question",
    ),
    path(
        "voxpops/<uuid:voxpop_id>/questions/stream",
        views.questions_stream_view,
        {"channel_prefix": ""},
    ...
    path(
        "admin/voxpops/<uuid:voxpop_id>/<uuid:question_id>",
        views.admin_question_set_state,
        name="admin_question_set_state",
    ),
    path(
        "admin/voxpops/<uuid:voxpop_id>/questions/stream",
        views.questions_stream_view,
        {"channel_prefix": "admin_"},
        name="admin_questions_stream",
    ),
]
